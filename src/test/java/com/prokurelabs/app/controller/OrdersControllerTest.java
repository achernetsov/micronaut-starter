...
public class OrdersControllerTest {
    ...
    @Test
    public void testFindNonExistingOrderReturns404() {
        HttpClientResponseException thrown = assertThrows(HttpClientResponseException.class,
...
//
//        HttpRequest request = HttpRequest.POST("/orders", new GenreSaveCommand("DevOps")); // <3>
...
//    }
    ...
    protected Long entityId(@SuppressWarnings("rawtypes") HttpResponse response) {
        String path = "/genres/";
